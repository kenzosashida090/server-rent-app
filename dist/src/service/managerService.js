...
export const getManagerDB = async (cognitoId) => {
    const manager = await prisma.manager.findUnique({
        where: { cognitoId }
    });
    return manager;
};
export const createManagerDB = async (data) => {
    const manager = await prisma.manager.create({
        data
    });
    return manager;
};
export const updateManagerDB = async (cognitoId, data) => {
...
export const getManagerPropertiesDB = async (managerId) => {
    try {
